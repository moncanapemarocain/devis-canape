...
def generer_pdf_devis(config, prix_details, schema_image=None, breakdown_rows=None, reduction_ttc=0.0):
    ...
    if "U" in type_canape:
        ...
        # Déterminer le nombre d'accoudoirs (0, 1 ou 2) selon les options renseignées.
        acc_count = 0
        ...
        # Déterminer les positions des dossiers. On vérifie différentes clefs pour assurer la compatibilité :
        # dossier_bas, dossier_left/dossier_gauche et dossier_right/dossier_droite. La valeur est « Avec »
        # si tous les dossiers sont présents, « Sans » si aucun n'est sélectionné, sinon la liste des
        # positions activées séparées par des virgules.
